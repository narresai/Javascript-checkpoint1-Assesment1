...
> For the second one also the output will be '36' but it returns the value undefined due to not returning the function due to 2 parameters the JavaScript understands that it will take only 2 arguments and 3rd one will be ignored.
```
